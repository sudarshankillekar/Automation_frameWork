...
public class TR_Customer_pojo {
	...
	public TR_Customer_pojo(int id, String first_name, String last_name, String mobile_number, String mobile_number_alt,
			String email_id, String email_id_alt, String tr_customer_address_id, int is_active, String created_at,
			String modified_at) {
		super();
		this.id = id;
	...
	public String getTr_customer_address_id() {
		return tr_customer_address_id;
	}
	public void setTr_customer_address_id(String tr_customer_address_id) {
		this.tr_customer_address_id = tr_customer_address_id;
	}
